...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => public_path('assets/fonts/NotoSansTamil-Regular.ttf'),
        ...
        'font_data' => [
            'notosanstamil' => [
                'R' => public_path('assets/fonts/NotoSansTamil-Regular.ttf'), // Regular Tamil font
            ],
        ],

        'default_font' => 'notosanstamil', // Set default to Tamil font
